...
1. Download the `starline-card.js` from the [latest release](https://github.com/Anonym-tsk/homeassistant-starline-card/releases/latest) and store it in your `configuration/www` folder.
